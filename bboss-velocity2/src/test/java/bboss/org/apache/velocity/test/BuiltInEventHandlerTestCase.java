...
public class BuiltInEventHandlerTestCase extends BaseTestCase {
   ...
   private static final String COMPARE_DIR = TEST_COMPARE_DIR + "/includeevent/compare";
    ...
    public void testEscapeReferenceMatch() throws Exception
    {
        ...
        VelocityEngine ve = new VelocityEngine();
        ve.setProperty(RuntimeConstants.EVENTHANDLER_REFERENCEINSERTION, "bboss.org.apache.velocity.app.event.implement.EscapeHtmlReference,org.apache.velocity.app.event.implement.EscapeJavaScriptReference");
