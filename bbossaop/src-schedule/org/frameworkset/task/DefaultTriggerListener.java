...
public class DefaultTriggerListener  extends BaseTriggerListener {
	...
	public void triggerComplete(Trigger trigger, JobExecutionContext context,
		...
		log.info("Default trigger Complete:ºÄÊ±"+context.getJobRunTime()+" milliseconds,["+context.toString()+"],[triggerInstructionCode="+triggerInstructionCode+"]");
