...
public class DefaultGlobalJobListener extends BaseJobListener {
	...
	public void jobWasExecuted(JobExecutionContext arg0,
		...
		if(arg1!=null)
			log.info("Global job Was Executed:ºÄÊ±"+arg0.getJobRunTime()+" milliseconds,[" + StringUtil.exceptionToString(arg1)+"]");
		else
			log.info("Global job Was Executed:ºÄÊ±"+arg0.getJobRunTime()+" milliseconds");
	} 
