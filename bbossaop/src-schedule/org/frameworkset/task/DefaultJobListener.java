...
public class DefaultJobListener extends BaseJobListener {
	...
	public void jobWasExecuted(JobExecutionContext arg0,
		...
		if(arg1!=null)
			log.info("job Was Executed:ºÄÊ±"+arg0.getJobRunTime()+" milliseconds,[" + StringUtil.exceptionToString(arg1)+"]");
		else
			log.info("job Was Executed:ºÄÊ±"+arg0.getJobRunTime()+" milliseconds");
	}
