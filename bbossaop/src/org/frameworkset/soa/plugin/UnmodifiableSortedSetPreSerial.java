...
public class UnmodifiableSortedSetPreSerial implements PreSerial<SortedSet> {
	...
	public UnmodifiableSortedSetPreSerial() {
		
	}

	public SortedSet prehandle(SortedSet object) {
		
		return (SortedSet)unmodify.getPropertyValue(object, "ss");
	}

	public SortedSet posthandle(SortedSet object) {
		if(object == null)
			return null;
		return Collections.unmodifiableSortedSet(object);
	}
