...
<body class="page-header-fixed">
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu">
				...
				<li class="active ">
					<a href="javascript:;">
					<i class="fa fa-th"></i> 
					<span class="title">BSPF DB Tables</span>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="portlet box green">
						...
						<div class="portlet-body flip-scroll" id="tablemetacontainer">
							请选择要生成代码的表！
						</div>
					</div>
	...
	<script>
		...
		{
			$("#tablemetacontainer").load("tablemeta.page #tablecontent",{tableName:tableName});
		}
	</script>
</body>
<!-- END BODY -->
