...
/**
 * <p>DefaultCMSCallBackFactory.java</p>
 * <p> Description: </p>
 * <p> bboss workgroup </p>
 ...
 * @version 1.0
 */
public class DefaultCMSCallBackFactory implements CMSCallBackFactory {

	public DefaultCMSCallBackFactory() {
	...
	public CMSCallBack getCMSCallBack(CMSServletRequest cmsrequest) {
		...
		return new DefaultCMSCallBack(cmsrequest);
	}
	...
	public CMSCallBack getCMSCallBack() {
		return new DefaultCMSCallBack(null);
	}
