...
import bboss.org.apache.velocity.app.event.implement.EscapeHtmlReference;
import bboss.org.apache.velocity.app.event.implement.EscapeJavaScriptReference;
import bboss.org.apache.velocity.app.event.implement.EscapeReference;
import bboss.org.apache.velocity.app.event.implement.EscapeSqlReference;
import bboss.org.apache.velocity.app.event.implement.EscapeXmlReference;
import bboss.org.apache.velocity.app.event.implement.InvalidReferenceInfo;
import bboss.org.apache.velocity.app.event.implement.ReportInvalidReferences;
...
public class BuiltInEventHandlerTestCase extends BaseTestCase {
   ...
   private static final String COMPARE_DIR = TEST_COMPARE_DIR + "/includeevent/compare";
    ...
    {
        VelocityEngine ve = new VelocityEngine();
        ve.setProperty(RuntimeConstants.EVENTHANDLER_REFERENCEINSERTION, "bboss.org.apache.velocity.app.event.implement.EscapeHtmlReference");
        ve.init();
    ...
    public void testEscapeReferenceMatch() throws Exception
    {
        ...
        VelocityEngine ve = new VelocityEngine();
        ve.setProperty(RuntimeConstants.EVENTHANDLER_REFERENCEINSERTION, "bboss.org.apache.velocity.app.event.implement.EscapeHtmlReference,bboss.org.apache.velocity.app.event.implement.EscapeJavaScriptReference");
    ...
    public void testPrintExceptionHandler() throws Exception
    {
        ...
        ve1.setProperty(RuntimeConstants.EVENTHANDLER_METHODEXCEPTION, "bboss.org.apache.velocity.app.event.implement.PrintExceptions");
        ve1.init();

        VelocityEngine ve2 = new VelocityEngine();
        ve2.setProperty(RuntimeConstants.EVENTHANDLER_METHODEXCEPTION, "bboss.org.apache.velocity.app.event.implement.PrintExceptions");
        ve2.setProperty("eventhandler.methodexception.templateinfo","true");
        ve2.init();

        VelocityEngine ve3 = new VelocityEngine();
        ve3.setProperty(RuntimeConstants.EVENTHANDLER_METHODEXCEPTION, "bboss.org.apache.velocity.app.event.implement.PrintExceptions");
    ...
    {
        VelocityEngine ve = new VelocityEngine();
        ve.setProperty(RuntimeConstants.EVENTHANDLER_INCLUDE, "bboss.org.apache.velocity.app.event.implement.IncludeNotFound");
    ...
    public void testIncludeNotFoundMissingResourceName() throws Exception
    {
        ...
        engine.setProperty(RuntimeConstants.EVENTHANDLER_INCLUDE, "bboss.org.apache.velocity.app.event.implement.IncludeNotFound");
    ...
    {
        VelocityEngine ve = new VelocityEngine();
        ve.setProperty(RuntimeConstants.EVENTHANDLER_INCLUDE, "bboss.org.apache.velocity.app.event.implement.IncludeRelativePath");
        ve.addProperty(RuntimeConstants.FILE_RESOURCE_LOADER_PATH, FILE_RESOURCE_LOADER_PATH);
        ve.init();
