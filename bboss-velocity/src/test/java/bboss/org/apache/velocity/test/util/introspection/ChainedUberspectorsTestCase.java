package bboss.org.apache.velocity.test.util.introspection;
...
import bboss.org.apache.velocity.util.introspection.AbstractChainableUberspector;
...
public class ChainedUberspectorsTestCase extends BaseTestCase {
            ...
            throws Exception
    {
        ...
        Velocity.addProperty(Velocity.UBERSPECT_CLASSNAME,"bboss.org.apache.velocity.util.introspection.UberspectImpl");
        Velocity.addProperty(Velocity.UBERSPECT_CLASSNAME,"bboss.org.apache.velocity.test.util.introspection.ChainedUberspectorsTestCase$ChainedUberspector");
        Velocity.addProperty(Velocity.UBERSPECT_CLASSNAME,"bboss.org.apache.velocity.test.util.introspection.ChainedUberspectorsTestCase$LinkedUberspector");
        Velocity.init();
    }
