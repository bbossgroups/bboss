...
public class DeprecatedCheckUberspectorsTestCase extends BaseTestCase {
    ...
    protected void setUpEngine(VelocityEngine engine)
    {
        ...
        engine.addProperty(Velocity.UBERSPECT_CLASSNAME, "bboss.org.apache.velocity.util.introspection.UberspectImpl");
        engine.addProperty(Velocity.UBERSPECT_CLASSNAME, "bboss.org.apache.velocity.util.introspection.DeprecatedCheckUberspector");
    }
