...
import bboss.org.apache.velocity.app.FieldMethodizer;
...
import bboss.org.apache.velocity.test.provider.BoolObj;
import bboss.org.apache.velocity.test.provider.NullToStringObject;
import bboss.org.apache.velocity.test.provider.TestNumber;
import bboss.org.apache.velocity.test.provider.TestProvider;
...
public class TemplateTestCase extends BaseTestCase implements TemplateTestBase
{
       ...
       throws Exception
    {
        ...
        context.put("runtime", new FieldMethodizer( "bboss.org.apache.velocity.runtime.RuntimeSingleton" ));
