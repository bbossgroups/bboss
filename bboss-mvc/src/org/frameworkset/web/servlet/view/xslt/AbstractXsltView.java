...
package org.frameworkset.web.servlet.view.xslt;
...
import org.frameworkset.util.xml.SimpleTransformErrorListener;
import org.frameworkset.util.xml.TransformerUtils;
 ...
 * <p>Properties:
 * <ul>
 * <li>{@link #setStylesheetLocation(Resource) stylesheetLocation}:
 ...
 * @deprecated since ; superseded by {@link XsltView} and its
...
public abstract class AbstractXsltView extends AbstractView {
	 ...
	 * {@link  ApplicationContext} to do it.
	 */
	@Override
