 ...
 *
 * <p>Note: Bboss's VelocityView requires Velocity 1.4 or higher, and optionally
...
public class VelocityView extends AbstractTemplateView {
	 ...
	 * the current locale, as determined by Bboss's LocaleResolver.
	 * <p>DateTool is part of the generic package of Velocity Tools 1.0.
	 * Bboss uses a special locale-aware subclass of DateTool.
	 ...
	 * Bboss uses a special locale-aware subclass of NumberTool.
	...
	protected VelocityEngine autodetectVelocityEngine() throws BeansException {
		try {
			VelocityConfig velocityConfig = 
				(VelocityConfig)getApplicationContext().getBeanObject("velocityConfig");
