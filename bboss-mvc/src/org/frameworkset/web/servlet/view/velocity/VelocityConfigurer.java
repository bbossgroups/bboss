...
package org.frameworkset.web.servlet.view.velocity;
...
import org.frameworkset.ui.velocity.VelocityEngineFactory;
 ...
 *
 * <pre class="code">
 * &lt;bean id="velocityConfig" class="org.frameworkset.web.servlet.view.velocity.VelocityConfigurer"&gt;
 *   &lt;property name="resourceLoaderPath">&lt;value&gt;/WEB-INF/velocity/&lt;/value>&lt;/property&gt;
 * &lt;/bean&gt;</pre>
 *
 * This bean must be included in the application context of any application
 * using Bboss's {@link VelocityView} for web MVC. It exists purely to configure
 ...
 * {@link org.frameworkset.ui.velocity.VelocityEngineFactoryBean},
 * This allows to share a VelocityEngine for web and email usage, for example.
 *
 * <p>This configurer registers the "bboss.vm" Velocimacro library for web views
 * (contained in this package and thus in <code>bboss.jar</code>), which makes
 * all of Bboss's default Velocity macros available to the views.
 * This allows for using the bboss-provided macros such as follows:
 *
 * <pre class="code">
 * #bbossBind("person.age")
...
public class VelocityConfigurer extends VelocityEngineFactory
	...
	/** the name of the resource loader for Bboss's bind macros */
	private static final String MACRO_RESOURCE_LOADER_NAME = "bbossMacro";

	/** the key for the class of Bboss's bind macro resource loader */
	private static final String MACRO_RESOURCE_LOADER_CLASS = "bbossMacro.resource.loader.class";

	/** the name of Bboss's default bind macro library */
	private static final String MACRO_LIBRARY = "org/frameworkset/web/servlet/view/velocity/bbossmvc.vm";
	 ...
	 * {@link org.frameworkset.ui.velocity.VelocityEngineFactoryBean}.
	 * <p>Note that the bboss macros will <i>not</i> be enabled automatically in
	 * case of an external VelocityEngine passed in here. Make sure to include
	 * <code>bboss.vm</code> in your template loader path in such a scenario
	 ...
	 * loader in order to load the bboss Velocity macros from the class path.
	...
	protected void postProcessVelocityEngine(VelocityEngine velocityEngine) {
		...
		velocityEngine.setProperty(
				MACRO_RESOURCE_LOADER_CLASS, ClasspathResourceLoader.class.getName());
		velocityEngine.addProperty(
				VelocityEngine.RESOURCE_LOADER, MACRO_RESOURCE_LOADER_NAME);
		velocityEngine.addProperty(
				VelocityEngine.VM_LIBRARY, MACRO_LIBRARY);

		if (logger.isInfoEnabled()) {
			logger.info("ClasspathResourceLoader with name '" + MACRO_RESOURCE_LOADER_NAME +
