...
//		this.customArgumentResolvers = customArgumentResolvers;
	...
	public final Object invokeHandlerMethod(MethodData handlerMethod,
		...
		try {
			...
			{
				AbstractUrlHandlerMapping.exposeAttribute(HandlerMapping.PAGER_METHOD_FLAG_ATTRIBUTE, true, request);
				if(!handlerMethod.getMethodInfo().isDefinePageSize())
				{
					...
					AbstractUrlHandlerMapping.exposeAttribute(HandlerMapping.PAGER_PAGESIZE_FLAG_ATTRIBUTE, defaultSize, request);
