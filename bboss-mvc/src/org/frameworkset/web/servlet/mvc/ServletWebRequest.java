...
public class ServletWebRequest  extends ServletRequestAttributes implements NativeWebRequest {
	 ...
	 */
	public ServletWebRequest(HttpServletRequest request, HttpServletResponse response,PageContext pageContext) {
	...
	public String[] getHeaderValues(String headerName) {
		String[] headerValues = StringUtil.toStringArray(getRequest().getHeaders(headerName));
	...
	public boolean checkNotModified(String etag) {
		HttpServletResponse response = getResponse();
		if (StringUtil.hasLength(etag) && !this.notModified) {
			if (isCompatibleWithConditionalRequests(response)) {
