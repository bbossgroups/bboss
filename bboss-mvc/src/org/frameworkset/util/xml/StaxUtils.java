...
public abstract class StaxUtils {
	 ...
	 * @return <code>true</code> if <code>source</code> is a Bboss StaxSource or JAXP
	 ...
	 * @return <code>true</code> if <code>result</code> is a Bboss StaxResult or JAXP
	 ...
	 * @param source a Bboss StaxSource or JAXP 1.4 {@link javax.xml.transform.stax.StAXSource}
	 * @return the {@link javax.xml.stream.XMLStreamReader}
	 * @throws IllegalArgumentException if <code>source</code> is neither a Bboss StaxSource
	 ...
	 * @param result a Bboss StaxResult or JAXP 1.4 {@link javax.xml.transform.stax.StAXResult}
	 * @return the {@link javax.xml.stream.XMLStreamReader}
	 * @throws IllegalArgumentException if <code>source</code> is neither a Bboss StaxResult
