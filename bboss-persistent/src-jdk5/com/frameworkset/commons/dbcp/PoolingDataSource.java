...
/* JDBC_3_ANT_KEY_END */
		...
		/* (non-Javadoc)
		 * @see com.frameworkset.commons.dbcp.AbandonedTrace#printStackTrace()
		 */
		@Override
		public void printStackTrace() {
			// TODO Auto-generated method stub
			if(delegate != null && delegate instanceof AbandonedTrace)
				((AbandonedTrace)this.delegate).printStackTrace();
		}
    }
}
