 ...
 * {@link com.frameworkset.commons.dbcp2.cpdsadapter.DriverAdapterCPDS},
 ...
 * @version $Id: InstanceKeyDataSource.java 1658644 2015-02-10 08:59:07Z tn $
 * @since 2.0
 */
public abstract class InstanceKeyDataSource
    ...
    */
    ...
    /**
     * Gets the default value for
     * {@link com.frameworkset.commons.pool2.impl.GenericObjectPool GenericObjectPool#getSoftMinEvictableIdleTimeMillis()} for each
     * per user pool.
     */
    ...
    /**
     * Sets the default value for
     * {@link com.frameworkset.commons.pool2.impl.GenericObjectPool GenericObjectPool#getSoftMinEvictableIdleTimeMillis()} for each per user pool.
     */
    ...
    /**
     * Gets the default value for
     * {@link com.frameworkset.commons.pool2.impl.GenericObjectPool GenericObjectPool#getTestOnCreate()} for each per user pool.
     */
    ...
    /**
     * Gets the default value for
     * {@link com.frameworkset.commons.pool2.impl.GenericObjectPool GenericObjectPool#getTestOnBorrow()} for each per user pool.
     */
    ...
    /**
     * Gets the default value for
     * {@link com.frameworkset.commons.pool2.impl.GenericObjectPool GenericObjectPool#getTestOnReturn()} for each per user pool.
     */
    ...
    /**
     * Gets the default value for
     * {@link com.frameworkset.commons.pool2.impl.GenericObjectPool GenericObjectPool#getTestWhileIdle()} for each per user pool.
     */
    ...
    /**
     * Gets the default value for
     * {@link com.frameworkset.commons.pool2.impl.GenericObjectPool GenericObjectPool#getTimeBetweenEvictionRunsMillis ()} for each
     * per user pool.
     */
