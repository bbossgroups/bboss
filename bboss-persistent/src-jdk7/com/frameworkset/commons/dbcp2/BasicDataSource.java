...
public class BasicDataSource implements DataSource, BasicDataSourceMXBean, MBeanRegistration {
    ...
    /**
     * If the connection pool implements {@link com.frameworkset.commons.pool2.UsageTracking UsageTracking}, configure
...
//        }
    ...
    protected DataSource createDataSourceInstance() throws SQLException {
        PoolingDataSource<PoolableConnection> pds = new PoolingDataSource<PoolableConnection>(connectionPool);
