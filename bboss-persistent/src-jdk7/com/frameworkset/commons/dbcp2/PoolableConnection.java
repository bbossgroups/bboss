 ...
 * @author James House
 * @version $Revision: 1594068 $ $Date: 2014-05-12 12:32:44 -0700 (Mon, 12 May 2014) $
 * @since 2.0
 */
public class PoolableConnection extends DelegatingConnection<Connection>
    ...
    public void validate(String sql, int timeout) throws SQLException {
        ...
        try  {
        	rs = validationPreparedStatement.executeQuery();
            if(!rs.next()) {
        	...
        	SQLException localThrowable2_ = new SQLException(localThrowable1); 
        	localThrowable2 = localThrowable2_;
        	throw localThrowable2_;
