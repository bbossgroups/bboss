...
public class DelegatingResultSet extends AbandonedTrace implements ResultSet {
    ...
    { try { return _res.getObject(columnIndex, map); } catch (SQLException e) { handleException(e); return null; } }
    ...
    { try { return _res.getObject(columnLabel, map); } catch (SQLException e) { handleException(e); return null; } }
