 ...
 * @version 1.0
 */
public class DoubleTypeMethod extends BaseTypeMethod{
	@Override
	public void action(StatementInfo stmtInfo, Param param, PreparedStatement statement, PreparedStatement statement_count, List resources) throws SQLException {
		statement.setDouble(param.getIndex(), ((Double)param.getData()).doubleValue());
		if(statement_count != null)
		{
			statement_count.setDouble(param.getIndex(), ((Double)param.getData()).doubleValue());
		}
