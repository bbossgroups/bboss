 ...
 * @version 1.0
 */
public class Clob_int_ClobTypeMethod extends BaseTypeMethod{
	@Override
	public void action(StatementInfo stmtInfo, Param param, PreparedStatement statement, PreparedStatement statement_count, List resources) throws SQLException {
		statement.setClob(param.getIndex(), (Clob)param.getData());
		if(statement_count != null)
		{
			statement_count.setClob(param.getIndex(), (Clob)param.getData());
		}
	}
}
