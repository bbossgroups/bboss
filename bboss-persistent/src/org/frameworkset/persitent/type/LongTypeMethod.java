 ...
 * @version 1.0
 */
public class LongTypeMethod extends BaseTypeMethod{
	@Override
	public void action(StatementInfo stmtInfo, Param param, PreparedStatement statement, PreparedStatement statement_count, List resources) throws SQLException {
		...
		statement.setLong(param.getIndex(), ((Long)param.getData()).longValue());
		if(statement_count != null)
		{
			statement_count.setLong(param.getIndex(), ((Long)param.getData()).longValue());
		}
	}
}
