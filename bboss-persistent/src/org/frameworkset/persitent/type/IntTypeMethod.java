 ...
 * @version 1.0
 */
public class IntTypeMethod extends BaseTypeMethod{
	@Override
	public void action(StatementInfo stmtInfo, Param param, PreparedStatement statement, PreparedStatement statement_count, List resources) throws SQLException {
		...
		statement.setInt(param.getIndex(), ((Integer)param.getData()).intValue());
		if(statement_count != null)
		{
			statement_count.setInt(param.getIndex(), ((Integer)param.getData()).intValue());
		}
	}
}
