 ...
 * @version 1.0
 */
public class FloatTypeMethod extends BaseTypeMethod{
	@Override
	public void action(StatementInfo stmtInfo, Param param, PreparedStatement statement, PreparedStatement statement_count, List resources) throws SQLException {
		...
		statement.setFloat(param.getIndex(), ((Float)param.getData()).floatValue());
		if(statement_count != null)
		{
			statement_count.setFloat(param.getIndex(), ((Float)param.getData()).floatValue());
		}
	}
}
