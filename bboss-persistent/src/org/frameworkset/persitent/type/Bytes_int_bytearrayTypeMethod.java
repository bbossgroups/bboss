 ...
 * @version 1.0
 */
public class Bytes_int_bytearrayTypeMethod extends BaseTypeMethod{
	@Override
	public void action(StatementInfo stmtInfo, Param param, PreparedStatement statement, PreparedStatement statement_count, List resources) throws SQLException {
		...
		statement.setBytes(param.getIndex(), (byte[])(param.getData()));
		if(statement_count != null)
		{
			statement_count.setBytes(param.getIndex(), (byte[])(param.getData()));
		}
