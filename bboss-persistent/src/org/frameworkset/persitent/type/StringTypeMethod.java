 ...
 * @version 1.0
 */
public class StringTypeMethod extends BaseTypeMethod{
	@Override
	public void action(StatementInfo stmtInfo, Param param, PreparedStatement statement, PreparedStatement statement_count, List resources) throws SQLException {
		statement.setString(param.getIndex(), (String)param.getData());
		if(statement_count != null)
		{
			statement_count.setString(param.getIndex(), (String)param.getData());
		}
	}
}
