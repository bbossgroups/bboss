 ...
 * @version 1.0
 */
public class ByteTypeMethod extends BaseTypeMethod{
	@Override
	public void action(StatementInfo stmtInfo, Param param, PreparedStatement statement, PreparedStatement statement_count, List resources) throws SQLException {
		...
		statement.setByte(param.getIndex(), ((Byte)param.getData()).byteValue());
		if(statement_count != null)
		{
			statement_count.setByte(param.getIndex(), ((Byte)param.getData()).byteValue());
		}
	}
}
