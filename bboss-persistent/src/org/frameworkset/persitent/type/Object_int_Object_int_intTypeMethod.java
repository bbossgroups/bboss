 ...
 * @version 1.0
 */
public class Object_int_Object_int_intTypeMethod extends BaseTypeMethod{
	@Override
	public void action(StatementInfo stmtInfo, Param param, PreparedStatement statement, PreparedStatement statement_count, List resources) throws SQLException {
		...
		statement.setObject(param.getIndex(), data[0],((Integer)data[1]).intValue(),((Integer)data[2]).intValue());
		if(statement_count != null)
		{
			statement_count.setObject(param.getIndex(), data[0],((Integer)data[1]).intValue(),((Integer)data[2]).intValue());
		}
