 ...
 * @version 1.0
 */
public class NullIntStringTypeMethod extends BaseTypeMethod{
    public NullIntStringTypeMethod(){
        super(true);
    }
	@Override
	public void action(StatementInfo stmtInfo, Param param, PreparedStatement statement, PreparedStatement statement_count, List resources) throws SQLException {
		...
		statement.setNull(param.getIndex(), ((Integer)data[0]).intValue(),(String)data[1]);
		if(statement_count != null)
		{
			statement_count.setNull(param.getIndex(), ((Integer)data[0]).intValue(),(String)data[1]);
		}
	}
}
