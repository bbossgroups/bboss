 ...
 * @version 1.0
 */
public class BooleanTypeMethod extends BaseTypeMethod{
	@Override
	public void action(StatementInfo stmtInfo, Param param, PreparedStatement statement, PreparedStatement statement_count, List resources) throws SQLException {
		...
		statement.setBoolean(param.getIndex(), ((Boolean)param.getData()).booleanValue());
		if(statement_count != null)
		{
			statement_count.setBoolean(param.getIndex(), ((Boolean)param.getData()).booleanValue());
		}
	}
}
