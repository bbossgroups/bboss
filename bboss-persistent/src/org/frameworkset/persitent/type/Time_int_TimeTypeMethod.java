 ...
 * @version 1.0
 */
public class Time_int_TimeTypeMethod extends BaseTypeMethod{
	@Override
	public void action(StatementInfo stmtInfo, Param param, PreparedStatement statement, PreparedStatement statement_count, List resources) throws SQLException {
		...
		statement.setTime(param.getIndex(), (Time)param.getData());
		if(statement_count != null)
		{
			statement_count.setTime(param.getIndex(), (Time)param.getData());
		}
