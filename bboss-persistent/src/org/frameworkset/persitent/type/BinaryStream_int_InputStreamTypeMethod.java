 ...
 * @version 1.0
 */
public class BinaryStream_int_InputStreamTypeMethod extends BaseTypeMethod{
	@Override
	public void action(StatementInfo stmtInfo, Param param, PreparedStatement statement, PreparedStatement statement_count, List resources) throws SQLException {
		...
		try
		{
			...
			statement.setBinaryStream(param.getIndex(), in, ((Integer)data[1]).intValue());
			if(statement_count != null)
			{
				statement_count.setBinaryStream(param.getIndex(), in, ((Integer)data[1]).intValue());
			}
		}
