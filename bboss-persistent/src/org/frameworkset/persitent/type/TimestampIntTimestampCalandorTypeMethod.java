 ...
 * @version 1.0
 */
public class TimestampIntTimestampCalandorTypeMethod extends BaseTypeMethod{
	@Override
	public void action(StatementInfo stmtInfo, Param param, PreparedStatement statement, PreparedStatement statement_count, List resources) throws SQLException {
		...
		statement.setTimestamp(param.getIndex(), timestamp,(Calendar)data[1]);
		if(statement_count != null)
		{
			statement_count.setTimestamp(param.getIndex(), timestamp,(Calendar)data[1]);
		}
	}
}
