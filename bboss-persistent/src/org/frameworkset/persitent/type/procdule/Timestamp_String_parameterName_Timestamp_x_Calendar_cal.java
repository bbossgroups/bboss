 ...
 * @version 1.0
 */
public class Timestamp_String_parameterName_Timestamp_x_Calendar_cal  extends BaseTypeMethod {
	@Override
	public void action(StatementInfo stmtInfo, CallableParam param, CallableStatement cstmt) throws SQLException {
		...
		cstmt.setTimestamp(param.getParameterName(), timestamp,(Calendar)value[1]);
	}
}
