 ...
 * @version 1.0
 */
public class Object_String_parameterName_Object_x_int_targetSqlType_int_scale  extends BaseTypeMethod {
	@Override
	public void action(StatementInfo stmtInfo, CallableParam param, CallableStatement cstmt) throws SQLException {
		cstmt.setObject(param.getParameterName(), param.getData(), param.getSqlType(), param.getScale());
	}
}
