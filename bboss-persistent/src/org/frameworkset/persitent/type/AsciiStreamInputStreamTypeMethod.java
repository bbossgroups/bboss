 ...
 * @version 1.0
 */
public class AsciiStreamInputStreamTypeMethod extends BaseTypeMethod{
	@Override
	public void action(StatementInfo stmtInfo, Param param, PreparedStatement statement, PreparedStatement statement_count, List resources) throws SQLException {
		...
		try
		{
			...
			statement.setAsciiStream(param.getIndex(), in, ((Integer)data[1]).intValue());
			if(statement_count != null)
			{
				statement_count.setAsciiStream(param.getIndex(), in, ((Integer)data[1]).intValue());
			}
		}
