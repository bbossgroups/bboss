 ...
 * still include a {@link DriverManager} implementation. {@link ConnectionPoolDataSource}s are not used
 * within general applications. They are used by {@link DataSource} implementations that pool
 * {@link Connection}s, such as {@link com.frameworkset.commons.dbcp2.datasources.SharedPoolDataSource}. A J2EE container
    ...
    public PooledConnection getPooledConnection(final String pooledUserName, final String pooledUserPassword) throws SQLException {
        ...
        if (isPoolPreparedStatements()) {
            ...
            if (getMaxPreparedStatements() <= 0) {
                ...
                // see com.frameworkset.commons.pool2.impl.GenericKeyedObjectPool.clearOldest method
