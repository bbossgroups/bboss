...
//                throw new SQLException("Error preloading the connection pool", e);
    ...
    protected DataSource createDataSourceInstance() throws SQLException {
        final PoolingDataSource<PoolableConnection> pds = new PoolingDataSource<PoolableConnection>(connectionPool);
    ...
    /**
     * If the connection pool implements {@link com.frameworkset.commons.pool2.UsageTracking UsageTracking}, should the
    ...
    /**
     * If the connection pool implements {@link com.frameworkset.commons.pool2.UsageTracking UsageTracking}, configure whether
    ...
    public List<AbandonedTraceExt> getGoodTraceObjects()
    {
        if (connectionPool != null)
        {
            return connectionPool.getGoodTraceObjects();
