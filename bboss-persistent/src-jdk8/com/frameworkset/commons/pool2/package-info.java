 ...
 * Object pooling API.
 * <p>
 * The {@code com.frameworkset.commons.pool2. package defines a simple interface for a pool of object instances, and a handful of base classes that may be useful
 ...
 * </p>
 * <dl>
 * <dt>{@link com.frameworkset.commons.pool2.ObjectPool ObjectPool}</dt>
 * <dd>defines a simple object pooling interface, with methods for borrowing instances from and returning them to the pool.</dd>
 * <dt>{@link com.frameworkset.commons.pool2.PooledObjectFactory PooledObjectFactory}</dt>
 ...
 * {@link com.frameworkset.commons.pool2.KeyedObjectPool KeyedObjectPool} and {@link com.frameworkset.commons.pool2.KeyedPooledObjectFactory KeyedPooledObjectFactory}.
 * </p>
 */
