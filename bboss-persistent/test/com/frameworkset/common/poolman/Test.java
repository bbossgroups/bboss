...
public class Test {
    ...
    {
       try {
        System.out.println( DBUtil.getDataSourceByJNDI("bspf_datasource_jndiname"));
    ...
    static class TestThread extends Thread
	{
	    public void run()
	    {
	        ...
	        try {
	            for(int i = 0 ; i < 5; i ++)
	            {
	                System.out.println(this + "||result:" + dbutil.executeInsert("insert  into  oa_meetingpromptsound(soundCode,soundName,soundFileName) values('aaa','(b,b)','dd')"));	                
	            }
	        }
	        catch(Exception e)
	        {
